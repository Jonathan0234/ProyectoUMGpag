  ...
  <?php include("./layouts/header.php"); ?> 
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h2 class="h3 mb-3 text-black">Descripción de pedido</h2>
          </div>
          <div class="col-md-7">
          ...
          ?>
            <div class="p-4 border mb-3">
                <img src="./images/<?php echo $f['imagen'];?>" width="70px"/>
              <span class="d-block text-primary h5 text-uppercase"><?php echo $f['nombre_producto'];?></span> <br>
              <span class="d-block text-primary h5 text-uppercase">Cantidad:<?php echo $f['cantidad'];?></span>
              <span class="d-block text-primary h5 text-uppercase">Precio: Q<?php echo $f['precio'];?></span>
              <span class="d-block text-primary h5 text-uppercase">Subtotal: Q<?php echo $f['subtotal'];?></span>
            </div>
            <?php } ?>
            <h4>Total: Q<?php echo $datosUsuario[2];?></h4>
          </div>
        </div>
      </div>
    </div>
