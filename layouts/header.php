        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div class="site-logo">
                <img src="./images/logo.jpg" alt="Mimis Cakes" class="brand-image img-circle elevation-3" style="opacity: .8"  width="85px" height="85px">
                <a href="index.php" class="js-logo-clone">Mimi's Cakes</a>
              </div>
            </div>
            ...
            <div class="col-6 col-md-4 order-3 order-md-3 text-right">
              <div class="site-top-icons">
                <ul>
                  ...
                  <li><a href="#"><span class="icon icon--o"></span></a></li>
                  <li>
