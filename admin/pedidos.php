...
$resultado=$conexion->query("
  select ventas.*, usuario.nombre, usuario.telefono, usuario.email from ventas inner join usuario on ventas.id_usuario = usuario.id
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card">
          ...
          <div id="collapse<?php echo $f['id']; ?>" class="collapse show" aria-labelledby="heading<?php echo $f['id']; ?>" data-parent="#accordion">
            <div class="card-body">
          ...
          <thead>
            ...
            <tbody>
              ...
              <?php 
              $re=$conexion->query("select productos_venta.*, productos.nombre, productos.descripcion from productos_venta inner join productos on productos_venta.id_producto = productos.id where productos_venta.id_producto =productos.id") or die($conexion->error);
            ...
            <td>Q<?php echo number_format($f2['precio'],2,'.',''); ?></td>
            <td>
            <?php echo $f2['cantidad']; ?>
            </td>
            <td>
            Q<?php echo number_format($f2['subtotal'],2,'.',''); ?>
            </td>
            </tr>
           <?php }  ?>
            </tbody>
